...
import { getAuthToken, removeAuthToken, getAuthUsername } from '@/lib/auth';
...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      setUsername(getAuthUsername() || 'User');
    }
  }, [router]);
    ...
    <>
      ...
      <div className="app-container">
        <div className="hero">
            ...
            <div className="badge" style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
              <span style={{ opacity: 0.8 }}><i className="fas fa-user"></i> {username}</span>
              <button onClick={handleLogout} style={{ background: 'transparent', border: '1px solid #ef4444', color: '#ef4444', padding: '4px 12px', borderRadius: '20px', cursor: 'pointer', fontSize: '0.75rem', fontWeight: 'bold' }}>
                Logout
              </button>
            </div>
        </div>
